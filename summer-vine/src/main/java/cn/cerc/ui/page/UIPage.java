...
public abstract class UIPage extends AbstractPage implements SupportScriptFile {
    ...
    protected void initJsFile() {
        ...
        this.addScriptFile("https://oss.diteng.site/resources/reactjs/react.production.min.js");
        this.addScriptFile("https://oss.diteng.site/resources/reactjs/react-dom.production.min.js");
